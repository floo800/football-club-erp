package com.mnc.football.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.mnc.football.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.mnc.football.repository.UserRepository.USERS_BY_EMAIL_CACHE);
